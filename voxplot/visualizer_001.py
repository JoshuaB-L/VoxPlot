#!/usr/bin/env python3
"""
Enhanced Visualization module for VoxPlot analysis with fixes for:
1. Title spacing and overlap issues
2. White background for missing data
3. Equal layer division by voxel count
4. Improved 3D plot positioning
"""
...
class ForestStructureVisualizer:
    ...
    def create_crown_layer_comparison(self, comparison_results: Dict[str, Any], 
        ...
        """Create enhanced crown layer comparison with improved spacing and white backgrounds."""
        ...
        for row_idx, row_label, layer_key in row_info:
            ...
            for col_idx in range(n_models):
                ...
                if row_idx == 0:
                    ...
                    ax.text(0.5, 1.15, model_name, ha='center', va='bottom',  # More space above
        ...
        # Add enhanced colorbar with better positioning
    ...
    def _plot_crown_layer_raster_enhanced(self, ax, analysis, layer_key, density_type, vmin, vmax):
        ...
        if raster_data and raster_data['array'].size > 0 and np.any(raster_data['array'] > 0):
            ...
            # Enhanced text box styling with more space
            ...
            ax.text(0.5, 1.08, metrics_text, ha='center', va='bottom',  # More space above
                   transform=ax.transAxes, 
